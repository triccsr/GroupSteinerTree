...
graph_hash_of_mixed_weighted graph_hash_of_mixed_weighted_extract_subgraph_for_a_list_of_vertices(
	graph_hash_of_mixed_weighted& input_graph, std::list<int>& list_of_v) {
