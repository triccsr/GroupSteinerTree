	...
	*/
	...
	for (auto it = predesscors.begin(); it != predesscors.end(); it++) {
		...
		if (v1 != v2) { // predesscor of start_v is start_v
			...
			(postprocessed_MST, v1, v2, graph_hash_of_mixed_weighted_edge_weight(sub_graph, v1, v2));
		}
	}
...
graph_hash_of_mixed_weighted graph_hash_of_mixed_weighted_MST_postprocessing
(graph_hash_of_mixed_weighted& input_graph, graph_hash_of_mixed_weighted& theta) {
