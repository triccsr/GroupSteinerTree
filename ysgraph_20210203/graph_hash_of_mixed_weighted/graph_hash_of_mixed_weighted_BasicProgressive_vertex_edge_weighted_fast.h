...
#pragma region
graph_hash_of_mixed_weighted graph_hash_of_mixed_weighted_BasicProgressive_fast_G2(graph_hash_of_mixed_weighted& input_graph, double lambda) {
...
std::unordered_map<int, double> graph_hash_of_mixed_weighted_BasicProgressive_fast_find_LWPs_to_g
...
std::unordered_map<int, std::unordered_map<int, double>> graph_hash_of_mixed_weighted_BasicProgressive_fast_find_LWPs
(graph_hash_of_mixed_weighted& input_graph, graph_hash_of_mixed_weighted& group_graph, std::unordered_set<int>& cumpulsory_group_vertices, double lambda) {
	...
	/*return {g_ID, { distances}}*/

	/*time complexity: O(|V|+|E|)*/
	graph_hash_of_mixed_weighted G_2 = graph_hash_of_mixed_weighted_BasicProgressive_fast_G2(input_graph, lambda);
	...
	for (auto it = cumpulsory_group_vertices.begin(); it != cumpulsory_group_vertices.end(); it++) {
		int g_vertex = *it;
		LWPs_to_groups[g_vertex] = graph_hash_of_mixed_weighted_BasicProgressive_fast_find_LWPs_to_g(group_graph, G_2, g_vertex, lambda);
...
#pragma region
std::unordered_map<int, std::unordered_set<int>> graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_non_overlapped_group_sets(int group_sets_ID_range) {
...
#pragma endregion graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_non_overlapped_group_sets

#pragma region
struct graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node {
	int v;
	int p; // group_set_ID
	double priority_value; // cost of T(v,p)
};
bool operator<(graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node const& x, graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node const& y) {
...
typedef typename boost::heap::fibonacci_heap<graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node>::handle_type handle_graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node;
#pragma endregion graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast priority queue

#pragma region
class graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_tree_node
{
...
#pragma endregion graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_tree_node

#pragma region
int graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_vertex_group_set_ID(int vertex, graph_hash_of_mixed_weighted& group_graph,
...
#pragma endregion graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_vertex_group_set_ID

#pragma region
std::unordered_map<int, std::unordered_set<int>> graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_uncovered_groups(int group_sets_ID_range,
	std::unordered_set<int>& cumpulsory_group_vertices) {
...
#pragma endregion graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_uncovered_groups

#pragma region
graph_hash_of_mixed_weighted graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_build_tree(int root_v, int root_p, graph_hash_of_mixed_weighted& input_graph,
	std::unordered_map<int, std::unordered_map<int, graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_tree_node>>& trees) {
...
#pragma endregion graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_build_tree

#pragma region
double graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_treeCost(graph_hash_of_mixed_weighted& theta, double lambda) {
...
#pragma endregion graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_treeCost

graph_hash_of_mixed_weighted graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast(graph_hash_of_mixed_weighted& input_graph, graph_hash_of_mixed_weighted& group_graph,
	std::unordered_set<int>& cumpulsory_group_vertices, double lambda, std::unordered_map<int, std::unordered_map<int, double>>& LWPs_to_groups) {

	/*cost function: (1 - lambda) * vertex_weights + lambda * edge_weights */


	if (cumpulsory_group_vertices.size() >= 20) {
		std::cout << "cumpulsory_group_vertices.size() is too large for graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast!" << std::endl;
		exit(1);
	}
	...
	/*initialize Q*/
	boost::heap::fibonacci_heap<graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node> Q_T; // min queues of trees
	std::unordered_map<string, handle_graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node>
	...
	std::unordered_map<int, std::unordered_set<int>> non_overlapped_group_sets_IDs =
		graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_non_overlapped_group_sets(group_sets_ID_range);  // time complexity: O(4^|Gamma|)


	/*initialize uncovered_groups;  <p, <uncovered_groups>>;  time complexity: O(|Gamma|*2^|Gamma|)*/
	std::unordered_map<int, std::unordered_set<int>> uncovered_groups = graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_uncovered_groups(
	...
	*/
	std::unordered_map<int, std::unordered_map<int, graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_tree_node>> trees; // <v, <p, T(v,p)>>
	for (auto it = input_graph.hash_of_vectors.begin(); it != input_graph.hash_of_vectors.end(); it++) {
		...
		trees[v] = {};
		int group_set_ID_v = graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_vertex_group_set_ID(v, group_graph, cumpulsory_group_vertices); /*time complexity: O(|Gamma|)*/
		for (int p = 1; p <= group_set_ID_v; p++) { // p is non-empty; time complexity: O(2^|Gamma|)
			if ((p | group_set_ID_v) == group_set_ID_v) { // p represents a non-empty group set inside group_set_ID_v, including group_set_ID_v
				...
				/*T(v,p)*/
				graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_tree_node node;
				node.cost = cost_v;
				node.type = 0;
				trees[v][p] = node;

				/*insert T(v,p) into Q_T*/
				graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node x;
				x.v = v;
				x.p = p;
	...
	while (Q_T.size() > 0) { // at most 2^|Gamma|*V loops
		...
		graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_min_node top_node = Q_T.top();
		...
		if (p == group_sets_ID_range) { // T(v,p) covers all groups 	
			graph_hash_of_mixed_weighted feasible_solu = graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast_build_tree(v, p, input_graph, trees); // time complexity: O(|V|)
	...
	std::cout << "graph_hash_of_mixed_weighted_BasicProgressive_vertex_edge_weighted_fast did not find a feasible solution!" << std::endl;
	getchar();
	exit(1);
