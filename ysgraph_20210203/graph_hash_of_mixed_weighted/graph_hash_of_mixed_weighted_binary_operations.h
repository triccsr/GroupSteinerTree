...
bool graph_hash_of_mixed_weighted_binary_operations_search(std::vector<pair<int, double>>& input_vector, int key) {
...
int graph_hash_of_mixed_weighted_binary_operations_search_position(std::vector<pair<int, double>>& input_vector, int key) {
...
void graph_hash_of_mixed_weighted_binary_operations_erase(std::vector<pair<int, double>>& input_vector, int key) {
...
void graph_hash_of_mixed_weighted_binary_operations_insert(std::vector<pair<int, double>>& input_vector, int key, double load) {
